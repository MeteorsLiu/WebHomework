            ...
            <div className="flex justify-center items-center mt-10 h-[70vh]">
                ...
                <div className="w-[26.5rem]  bg-white flex flex-col rounded pt-10">
                    ...
                    <div className="flex flex-col items-center w-full">
                        ...
                        <div className="w-3/4 py-2">
                            <input className="px-2 rounded w-full border  py-2 border-slate-200 focus:border-blue-300  " type="password" placeholder="请再次输入密码" />
                        </div>

                        <div className="w-3/4 py-2">
                            <input className="px-2 rounded w-full border  py-2 border-slate-200 focus:border-blue-300  " type="password" placeholder="请输入邮箱" />
                        </div>

                        <div className="w-3/4 py-1 ">
                            <button className="py-2 text-center bg-[#007fff]  rounded w-full text-white">注册</button>
                        </div>
                    </div>
